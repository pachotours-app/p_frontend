...
export const Footer = () => {
  ...
  return (
	...
	<a href="https://wa.me/573203755982?text=Hello!%20I%20want%20to%20take%20a%20tour%20with%20Pacho." target="_blank" rel="noopener noreferrer"><Icon icon="mdi:whatsapp" className={styles.icon} /></a>
	      </section>
      <hr />
